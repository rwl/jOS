...
//  source: /Users/rwl/src/tball/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/TreeMap.java
//
...
@property (nonatomic, retain) JavaUtilTreeMap_SubMap *subMap;
...
@interface JavaUtilTreeMap_$1 : JavaUtilAbstractSet {
 @public
  JavaUtilTreeMap *this$0_;
}
